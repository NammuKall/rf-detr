...
class Model:
    def __init__(self, **kwargs):
        ...
        if args.pretrain_weights is not None:
            ...
            checkpoint_available = download_pretrain_weights(args.pretrain_weights, redownload=False, validate=True)
            ...
            if not checkpoint_available:
                ...
                if checkpoint_name not in HOSTED_MODELS and args.pretrain_weights not in HOSTED_MODELS:
                    ...
                    checkpoint_available = download_pretrain_weights(
                        args.pretrain_weights, redownload=True, validate=True
                    )
                    if not checkpoint_available:
                        raise RuntimeError(
